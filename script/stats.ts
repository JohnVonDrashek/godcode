...
async function fetchReleases(): Promise<Release[]> {
  ...
  while (true) {
    const url = `https://api.github.com/repos/crusadesoft/holycode/releases?page=${page}&per_page=${per}`
...
console.log("Fetching GitHub releases for crusadesoft/holycode...\n")
...
console.log("Fetching npm all-time downloads for holycode...\n")
const npmDownloads = await fetchNpmDownloads("holycode")
