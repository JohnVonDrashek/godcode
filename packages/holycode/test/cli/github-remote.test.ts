...
test("parses https URL with .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/crusadesoft/holycode.git")).toEqual({
    owner: "crusadesoft",
    repo: "holycode",
  })
})
...
test("parses https URL without .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/crusadesoft/holycode")).toEqual({
    owner: "crusadesoft",
    repo: "holycode",
  })
})
...
test("parses git@ URL with .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:crusadesoft/holycode.git")).toEqual({
    owner: "crusadesoft",
    repo: "holycode",
  })
})
...
test("parses git@ URL without .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:crusadesoft/holycode")).toEqual({ owner: "crusadesoft", repo: "holycode" })
})

test("parses ssh:// URL with .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/crusadesoft/holycode.git")).toEqual({
    owner: "crusadesoft",
    repo: "holycode",
  })
})
...
test("parses ssh:// URL without .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/crusadesoft/holycode")).toEqual({
    owner: "crusadesoft",
    repo: "holycode",
  })
})
