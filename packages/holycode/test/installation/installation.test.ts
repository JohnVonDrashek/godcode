  ...
  describe("latest", () => {
    ...
    test("reads brew formulae API versions", async () => {
      const layer = testLayer(
        ...
        (cmd, args) => {
          ...
          if (cmd === "brew" && args.includes("--formula") && args.includes("crusadesoft/tap/holycode")) return ""
          if (cmd === "brew" && args.includes("--formula") && args.includes("holycode")) return "holycode"
          return ""
        },
      )
    ...
    test("reads brew tap info JSON via CLI", async () => {
      ...
      const layer = testLayer(
        ...
        (cmd, args) => {
          if (cmd === "brew" && args.includes("crusadesoft/tap/holycode") && args.includes("--formula")) return "holycode"
