...
import { DialogSound } from "./component/dialog-sound"
...
function App() {
  ...
  createEffect(() => {
    if (!terminalTitleEnabled() || Flag.HOLYCODE_DISABLE_TERMINAL_TITLE) return

    if (route.data.type === "home") {
      renderer.setTerminalTitle("HolyCode")
      return
    }
  ...
  command.register(() => [
    ...
    },
    {
      ...
      value: "docs.open",
      onSelect: () => {
        open("https://github.com/crusadesoft/holycode#readme").catch(() => {})
        dialog.clear()
      },
      category: "System",
    },
  ...
  sdk.event.on("installation.update-available", async (evt) => {
    ...
    await DialogAlert.show(
      dialog,
      "Update Complete",
      `Successfully updated to HolyCode v${result.data.version}. Please restart the application.`,
    )
...
function ErrorComponent(props: {
  ...
  const issueURL = new URL("https://github.com/crusadesoft/holycode/issues/new?template=bug-report.yml")
  ...
  issueURL.searchParams.set("holycode-version", Installation.VERSION)
