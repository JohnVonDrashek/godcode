...
import type { ProviderAuthAuthorization, ProviderAuthMethod } from "@crusadesoft/sdk/v2"
          ...
          opencode: (
            <box gap={1}>
              <text fg={theme.textMuted}>
                HolyCode Zen gives you access to all the best coding models at the cheapest prices with a single API
                key.
              </text>
              <text fg={theme.text}>
                Go to <span style={{ fg: theme.primary }}>https://holycode.ai/zen</span> to get a key
              </text>
            </box>
          ),
          "opencode-go": (
            <box gap={1}>
              <text fg={theme.textMuted}>
                HolyCode Go is a $10 per month subscription that provides reliable access to popular open coding models
                with generous usage limits.
              </text>
              <text fg={theme.text}>
                Go to <span style={{ fg: theme.primary }}>https://holycode.ai/zen</span> and enable HolyCode Go
              </text>
            </box>
          ),
