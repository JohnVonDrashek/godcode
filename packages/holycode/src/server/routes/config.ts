  ...
  new Hono()
    .get(
      ...
      describeRoute({
        ...
        description: "Retrieve the current HolyCode configuration settings and preferences.",
    ...
    .patch(
      ...
      describeRoute({
        ...
        description: "Update HolyCode configuration settings and preferences.",
    ...
    .patch(
      ...
      describeRoute({
        ...
        description: "Update the project vision stored in the hidden project config file for the current project.",
