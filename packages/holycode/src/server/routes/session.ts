  ...
  new Hono()
    .get(
      ...
      describeRoute({
        ...
        description: "Get a list of all HolyCode sessions, sorted by most recently updated.",
    ...
    .get(
      ...
      describeRoute({
        summary: "Get session",
        description: "Retrieve detailed information about a specific HolyCode session.",
        tags: ["Session"],
    ...
    .post(
      ...
      describeRoute({
        ...
        description: "Create a new HolyCode session for interacting with AI assistants and managing conversations.",
