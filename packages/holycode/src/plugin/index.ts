import type { Hooks, PluginInput, Plugin as PluginInstance } from "@crusadesoft/plugin"
import { Config } from "../config/config"
import { Bus } from "../bus"
import { Log } from "../util/log"
import { createHolycodeClient } from "@crusadesoft/sdk"
...
export namespace Plugin {
  ...
  export class Service extends ServiceMap.Service<Service, Interface>()("@holycode/Plugin") {}
      ...
      const cache = yield* InstanceState.make<State>(
        Effect.fn("Plugin.state")(function* (ctx) {
          ...
          yield* Effect.promise(async () => {
            const client = createHolycodeClient({
