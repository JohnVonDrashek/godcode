...
export type Config = {
  ...
  /**
   * Project vision that is injected as a dedicated system prompt layer for every non-isolated run
   */
  big_picture?: string
  layout?: LayoutConfig
  permission?: PermissionConfig
...
export type ConfigBigPictureUpdateData = {
  body?: {
    big_picture?: string
  }
  path?: never
...
export type ConfigBigPictureUpdateErrors = {
  /**
   * Bad request
   */
  400: BadRequestError
...
export type ConfigBigPictureUpdateError = ConfigBigPictureUpdateErrors[keyof ConfigBigPictureUpdateErrors]

export type ConfigBigPictureUpdateResponses = {
  /**
   * Successfully updated project big picture
   */
  200: boolean
}

export type ConfigBigPictureUpdateResponse = ConfigBigPictureUpdateResponses[keyof ConfigBigPictureUpdateResponses]
...
export type SessionAgentViewData = {
  body?: {
    sessionID?: string
    model?: {
      providerID: string
...
export type SessionAgentViewErrors = {
  /**
   * Bad request
   */
  400: BadRequestError
...
export type SessionAgentViewError = SessionAgentViewErrors[keyof SessionAgentViewErrors]

export type SessionAgentViewResponses = {
  /**
   * Agent request snapshot
   */
  200: {
    providerID: string
    modelID: string
...
export type SessionAgentViewResponse = SessionAgentViewResponses[keyof SessionAgentViewResponses]
