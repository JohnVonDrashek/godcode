...
function themes(dir: string) {
  if (!fs.existsSync(dir)) return {}
  return Object.fromEntries(
    Glob.scanSync("*.json", { cwd: dir, absolute: true, dot: true, symlink: true }).map((file) => [
      path.basename(file, ".json"),
      JSON.parse(fs.readFileSync(file, "utf8")) as ThemeJson,
    ]),
  )
}

export const DEFAULT_THEMES = themes(DotOpencode.file("themes"))
