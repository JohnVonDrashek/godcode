...
import { tool } from "@crusadesoft/plugin"
...
This tool searches PRs in the crusadesoft/holycode repository and returns LLM-friendly results including:
- PR number and title
- Author
