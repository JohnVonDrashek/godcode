...
- Also apply locale-specific guidance from `.holycode/glossary/<locale>.md` when available (for example, `zh-cn.md`).
...
holycode agent [command]
holycode agent create
holycode agent list
...
holycode session [command]
holycode session list
holycode session delete <sessionID>
opencode stats
opencode uninstall
opencode upgrade
...
.holycode/agents/
.holycode/commands/
.holycode/commands/test.md
.holycode/modes/
.holycode/plans/*.md
.holycode/plugins/
.holycode/skills/<name>/SKILL.md
.holycode/skills/git-release/SKILL.md
.holycode/tools/
.well-known/holycode
...
%USERPROFILE%\.config\opencode\holycode.jsonc
%USERPROFILE%\.config\opencode\plugins
%USERPROFILE%\.local\share\opencode
%USERPROFILE%\.local\share\opencode\log
<project-root>/.holycode/themes/*.json
<providerId>/<modelId>
<your-project>/.holycode/plugins/
~
~/...
~/.agents/skills/*/SKILL.md
~/.agents/skills/<name>/SKILL.md
...
~/.bashrc
~/.cache/holycode
~/.cache/holycode/node_modules/
~/.claude/CLAUDE.md
~/.claude/skills/
~/.claude/skills/*/SKILL.md
~/.claude/skills/<name>/SKILL.md
~/.config/holycode
~/.config/holycode/AGENTS.md
~/.config/holycode/agents/
~/.config/holycode/commands/
~/.config/holycode/modes/
~/.config/holycode/holycode.json
~/.config/holycode/holycode.jsonc
~/.config/holycode/plugins/
~/.config/holycode/skills/*/SKILL.md
~/.config/holycode/skills/<name>/SKILL.md
~/.config/holycode/themes/*.json
~/.config/holycode/tools/
~/.config/zed/settings.json
~/.local/share
~/.local/share/holycode/
~/.local/share/holycode/auth.json
~/.local/share/holycode/log/
~/.local/share/holycode/mcp-auth.json
~/.local/share/holycode/holycode.jsonc
~/.npmrc
~/.zshrc
~/code/
...
$HOME/projects/*
$XDG_CONFIG_HOME/holycode/themes/*.json
agent/
agents/
build/
commands/
...
https://holycode.ai/zen/v1/chat/completions
https://holycode.ai/zen/v1/messages
https://holycode.ai/zen/v1/models/gemini-3-flash
https://holycode.ai/zen/v1/models/gemini-3-pro
https://holycode.ai/zen/v1/responses
